...
class SR_Dataset(Dataset):
    def __init__(self, args, phase):
        ...
        if phase == 'train':
            print('Set14 is not training dataset!')
        elif phase == 'val' or phase == 'test':
            self.HR_path = os.path.join(args.dir_data, 'Classical_SR_datasets', 'Set14', 'Set14_HR')
            self.LR_path = os.path.join(args.dir_data, 'Classical_SR_datasets', 'Set14', 'Set14_bicLRx%d'%(args.scale))
